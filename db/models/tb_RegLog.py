...
class TbRegLog(Base):
    __tablename__ = 'tb_RegLog'
    id = Column(INTEGER, primary_key=True, nullable=False)
    SQLite_FileName = Column(NVARCHAR(128), nullable=False)
    SQLite_TimeStamp = Column(DATETIME, nullable=False)
    SQLite_SeqIdInBlob = Column(INTEGER, nullable=False)
    GUID = Column(CHAR(36), nullable=False)
    CmdType = Column(VARCHAR(16), nullable=False)
